<template>
  <div class="p-6 w-full text-black">
    <div class="mb-12 flex items-center justify-between">
      <h1 class="text-2xl font-semibold text-gray-800">BOOKING CALENDAR</h1>
    </div>

    <h2 class="text-base font-semibold">01/ New Download</h2>
    <hr class="my-2 border-gray-300" />

    <div class="flex flex-col lg:flex-row gap-8 justify-center items-start mt-6">
      <div class="flex flex-col items-center">
        ...
        <Datepicker
          ...
          :month-picker="false"
          :inline="true"
          class="w-64 border-gray-300 rounded-lg"
        />
      </div>

      <div class="flex flex-col gap-4">
        <label class="text-base font-semibold">Select Filter</label>
        <div class="flex flex-col border rounded-md overflow-hidden w-48">
          <button
            v-for="option in filterOptions"
            :key="option"
            @click="selectedFilter = option"
            :class="[
              'py-2 px-4 text-left text-base border hover:bg-gray-100 cursor-pointer focus:outline-none',
      ...
      <div class="mt-6">
        <table class="w-full text-sm text-left">
          ...
          <tbody>
            ...
            <tr
              v-for="record in paginatedDownloads"
              :key="record.id"
              class="text-[#1E1E1E]"
            >
        ...
        <div class="flex justify-center items-center mt-6 space-x-4">
          <button
            class="px-4 py-2 bg-gray-200 rounded-full text-base hover:bg-gray-300"
            @click="prevPage"
